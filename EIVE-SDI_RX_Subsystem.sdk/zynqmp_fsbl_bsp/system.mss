...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = AXI_DMA_Data_Gen
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Camera_Subsystem_Record_Subsystem_AXI_DMA_Data_Gen_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.5
 PARAMETER HW_INSTANCE = Camera_Subsystem_Record_Subsystem_axi_dma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = SDI_RX_Subsystem
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = Camera_Subsystem_SDI_RX_Subsystem_0
END
