...
src/psu_init.o: C:/Users/st143005/Desktop/EIVE-SDI_RX_Subsystem/EIVE-SDI_RX_Subsystem.sdk/zusys_wrapper_hw_platform_0/psu_init.c
	@echo 'Building file: $<'
	@echo 'Invoking: ARM v8 gcc compiler'
	aarch64-none-elf-gcc -DARMA53_64 -Wall -O0 -g3 -I"C:\Users\st143005\Desktop\EIVE-SDI_RX_Subsystem\EIVE-SDI_RX_Subsystem.sdk\zusys_wrapper_hw_platform_0" -c -fmessage-length=0 -MT"$@" -Os -flto -ffat-lto-objects -I../../zynqmp_fsbl_flash_bsp/psu_cortexa53_0/include -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@)" -o "$@" "$<"
